...
namespace MwcModApi.Commands
{
	class ScrewPlacementModCommand : ConsoleCommand
	{
		private readonly MwcModApi mod;
		...
		public ScrewPlacementModCommand(MwcModApi mod, Dictionary<string, Dictionary<string, Part>> modsParts)
		{
			this.mod = mod;
